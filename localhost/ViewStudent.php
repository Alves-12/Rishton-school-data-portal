...
<body>
  ...
  <table>
    ...
    <tr>
      <th width="150px">pupil ID<br>
        <hr>
      </th>
      <br>
      <th width="250px">pupil Name<br>
        <hr>
      </th>
      <br>
      <th width="150px">pupil Address<br>
        <hr>
      </th>
      <br>
    ...
    <?php
    $sql = mysqli_query($link, "SELECT PupilID, Pupil_Name, Pupil_DOB, Pupil_MedicalInfo, ParentID, ClassID FROM Pupil");
    while ($row = $sql->fetch_assoc()) {
      echo "
	<tr>
		<th>{$row['PupilID']}</th>
		<th>{$row['Pupil_Name']}</th>
		<th>{$row['Pupil_DOB']}</th>
		<th>{$row['Pupil_MedicalInfo']}</th>
    <th>{$row['ParentID']}</th>
    <th>{$row['ClassID']}</th>
	</tr>";
    }
